...
// Preload the model (better for performance)
useGLTF.preload('/nis.glb');

// 3D Model Component with proper error handling and loading state
const Model = () => {
  const gltf = useGLTF('/nis.glb');
  
  // Optional: Adjust the model position, rotation, and scale
  return (
    <group position={[0, -1, 0]} rotation={[0, Math.PI / 2, 0]} scale={[1.5, 1.5, 1.5]}>
