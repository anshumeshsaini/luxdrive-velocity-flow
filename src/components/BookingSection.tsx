...
const BookingSection: React.FC = () => {
  ...
  return (
    <div className="py-20 bg-gradient-to-b from-luxdrive-black/95 to-luxdrive-black" id="booking">
        ...
        <div className="max-w-6xl mx-auto glass-card rounded-2xl overflow-hidden">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 relative">
              <img 
                src="https://images.unsplash.com/photo-1563720223185-11069d516a8e?q=80&w=1200&auto=format&fit=crop" 
                alt="Luxury car keys" 
                className="w-full h-full object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-r from-luxdrive-black/70 to-transparent md:bg-gradient-to-b"></div>
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full px-6">
                <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready for the <span className="text-glow">Ultimate</span> Drive?</h3>
                <p className="text-white/80 hidden md:block">Book your dream car today and experience luxury on wheels.</p>
              </div>
            </div>
            
            {/* Right side - Form */}
            <div className="md:w-1/2 p-8 md:p-12">
              <h3 className="text-2xl font-bold text-white mb-6 md:hidden">Reserve Your Luxury Experience</h3>
              ...
              {formState === 'success' ? (
                <div className="h-full flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-white/70 mb-6">Your reservation has been successfully submitted. We'll contact you shortly.</p>
                  <div className="animate-pulse text-sm text-white/50">Redirecting...</div>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label className="block text-white/80 mb-2 text-sm">Car Model</label>
                    <div className="relative">
                      <select
                        name="carModel"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-white/80 mb-2 text-sm">Pickup Date</label>
                      <div className="relative">
                        <input
                          type="date"
                          name="pickupDate"
                    ...
                    <div>
                      <label className="block text-white/80 mb-2 text-sm">Return Date</label>
                      <div className="relative">
                        <input
                          type="date"
                          name="returnDate"
                  ...
                  <div>
                    <label className="block text-white/80 mb-2 text-sm">Number of Guests (Optional)</label>
                    <div className="relative">
                      <input
                        type="number"
                        name="guests"
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className={getFieldClasses('guests')}
                        placeholder="2"
                        min="1"
                        max="7"
                        disabled={formState === 'submitting'}
